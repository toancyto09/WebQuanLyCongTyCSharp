...
namespace WebQuanLyCongTy.Controllers
{
    public class PhongBansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDPhongBan,TenPhongBan")] PhongBan phongBan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDPhongBan,TenPhongBan")] PhongBan phongBan)
        {
            if (ModelState.IsValid)
            {
